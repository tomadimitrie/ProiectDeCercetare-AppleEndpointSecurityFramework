...
- (IBAction)installExtension:(id __unused)sender {
	...
	OSSystemExtensionRequest *req = [OSSystemExtensionRequest activationRequestForExtension:@"com.toma.endpointsecuritysample.extension" queue:dispatch_get_main_queue()];
